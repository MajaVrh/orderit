...
import { getFirestore, collection, query, onSnapshot, getDocs, getDoc, doc, addDoc } from "firebase/firestore"
...
export { db, collection, query, onSnapshot, getDocs, getDoc, doc, addDoc  }