<template>
  <div class="DodavanjeKategorije">
    ...
    <button class="gumb2" v-if="Vidljiv">
      ...
      <input class="UpisiKategoriju" 
      v-model="PotkategorijaIme"
            placeholder=" Ime potkategorije"
      v-if="Vidljiv" type="text" />
      <button  class="potvrdiKategoriju" v-if="Vidljiv" @click="DodajGlavnuKategoriju ">Potvrdi</button>
    </button>
...
.potvrdiKategoriju{background-color: #ffffff;
color: #731642;    border-radius: 7px;
margin-top: 1rem;
...
.UpisiKategoriju{  border-radius: 7px;
  font-size: 14px;
